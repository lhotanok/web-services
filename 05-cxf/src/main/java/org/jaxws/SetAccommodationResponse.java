...
@XmlRootElement(name = "setAccommodationResponse", namespace = "http://org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "setAccommodationResponse", namespace = "http://org/")

public class SetAccommodationResponse {
